"""天链机械臂 6 轴 + F710 手柄遥操作 — 通用 Gazebo 仿真启动文件 (C++)。
...
def generate_launch_description():
    ...
    config_path = os.path.join(teleop_share, "config", "tl_teleop_f710_6axis_sim.yaml")
    gazebo_launch = PathJoinSubstitution(
        [gazebo_share, "launch", "gazebo_6axis_f710_sim.launch.py"]
    )
