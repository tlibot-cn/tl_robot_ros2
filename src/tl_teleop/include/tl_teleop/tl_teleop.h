...
public:
  ...
  static void on_pxrea_client_cb(void *context, PXREAClientCallbackType type,
                                 int status, void *userData);

  void run_control_loop();
  void shutdown_teleop(rclcpp::Executor &exec);
...
private:
  ...
  rclcpp::Client<tl_ros2_interface::srv::SetCurrentMode>::SharedPtr
  ...
  rclcpp::Client<tl_ros2_interface::srv::CoordTransform>::SharedPtr
      coord_transform_client_;
  rclcpp::Client<tl_ros2_interface::srv::GetPosTransform>::SharedPtr
      get_rpy2quat_client_;
  ...
  rclcpp::Subscription<tl_ros2_interface::msg::CartesianPose>::SharedPtr
      tcp_pose_sub_;
  ...
  std::vector<double> get_inverse_kinematics(double x, double y, double z,
  ...
  static std::array<double, 4> quat_multiply(const std::array<double, 4> &q1,
