...
public:
  ...
  static void on_pxrea_client_cb(void *context, PXREAClientCallbackType type, int status, void *userData);
...
private:
  ...
  std::vector<double> get_inverse_kinematics(double x, double y, double z, double rx, double ry, double rz);
